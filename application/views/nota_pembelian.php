  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
       ...
       <div class="card-body">
       	<div class="table" style="color: black;">
       		<h5 style="color: black"><center><b>Nota Pembelian Produk</b></center></h5><hr style="height: 2px; background-color: black">
           ...
           <?php } ?>
            ...
            <?php } ?>
       		...
       		<a href="<?php echo base_url() ?>index.php/pembelian" class="btn btn-danger"><span class="fa fa-hand-o-left"> Kembali</span></a>
