                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped" id="sortable-table">
                        ...
                        <tbody>
                          <tr>
                          <form action="<?php echo base_url() ?>index.php/pembelian/addcart" method="POST">
                            <td style="width: 140px; font-weight: bold">Auto</td>
                            ...
                            <td>Auto</td>
                            <td>Auto</td>
                            <td><button type="submit" class="btn btn-primary"><span class="fas fa-plus"></span></button></td>
                          </form>
                          </tr>
                          <?php 
                            $total = 0;
                          ...
                          ?>
                            <tr>
                              ...
                              <td><a href="<?php echo base_url() ?>index.php/pembelian/delete_temp_beli/<?= $key->id ?>" class="btn btn-danger"><span class="fas fa-trash"></span></a></td>
                            </tr>
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo base_url() ?>index.php/pembelian/save_cart">
